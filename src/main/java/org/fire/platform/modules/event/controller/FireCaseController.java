...
@Controller
@RequestMapping("/fireCase")
public class FireCaseController{

	@Autowired
	private IFireCaseService service;
	private static Logger log = LoggerFactory.getLogger(FireCaseController.class);
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<FireCase> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public FireCase get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody FireCase bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody FireCase bean){
