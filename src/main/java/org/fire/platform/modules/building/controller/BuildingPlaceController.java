...
@Controller
@RequestMapping("/buildingPlace")
public class BuildingPlaceController{

	@Autowired
	private IBuildingPlaceService service;
	private static Logger log = LoggerFactory.getLogger(BuildingPlaceController.class);
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<BuildingPlace> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public BuildingPlace get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody BuildingPlace bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody BuildingPlace bean){
