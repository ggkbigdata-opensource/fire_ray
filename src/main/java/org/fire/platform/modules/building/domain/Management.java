...
public class Management extends BaseEntity {
    ...
    private Integer primaryCredential; // 初级消防持证人数
    private Integer secondaryCredential; // 中级消防持证人数
    private String qualificationLevel;   //物业等级
    ...
    public Integer getPrimaryCredential() {
        return primaryCredential;
    }

    public void setPrimaryCredential(Integer primaryCredential) {
        this.primaryCredential = primaryCredential;
    }

    public Integer getSecondaryCredential() {
        return secondaryCredential;
    }

    public void setSecondaryCredential(Integer secondaryCredential) {
