	...
	public FireSystem get(@RequestParam(value = "id") Long id){
	 ...
	 public CommonResult create(FireSystem bean,HttpSession session,@RequestParam(value = "id") Long buildingId){
	     ...
	     try{
			 ...
			 String[] fireSystemNames = {"hydrant001","automaticFire002","waterSpraySystem003","gasFire004","automaticAlarm005","smokeSystem006","fireproofRolling007","powerSupply008","evacuationIndicating009",
					 "buildingExtinguisher010"};
			 String[][] constituentNames={
				{"室外消火栓","室内消火栓","消火栓泵","稳压泵","气压罐","水泵接合器","消防水泵控制柜","消防水池","消防水箱"},
				{"喷淋泵","稳压泵","气压罐","水泵接合器","报警阀","压力开关","信号阀","水流指示器","喷头","消防水泵控制柜"},
				{"消防水泵","稳压泵","气压罐","雨淋阀 （电动阀）","喷头","消防水泵控制柜"},
				{"气体灭火控制器","储存容器","驱动钢瓶","管网泄压装置","喷头","选择阀","手动控制装置","气体喷放指示灯","火灾声光报警器"},
				{"火灾报警控制器","消防联动控制器","火灾显示盘","图形显示装置","感烟探测器","感温探测器","手动 火灾报警装置","消火栓启动按钮","火焰探测器","其他探测器","火灾警报装置","消防应急广播","电话插孔","消防电梯","可燃气体控制器","可燃气体探测器","电气火灾监控器","电气火灾监控探测器"},
				{"加压送风机","加压送风阀","排烟风机","排烟阀","排烟防火阀","挡烟垂壁","通风、空调 防火阀","补风机"},
				{"防火门监控器","防火门","防火窗","防火卷帘控制器","防火卷帘"},
				{"消防设备配电","市电电源","自备发电机（功率）","双电源切换装置"},
				{"应急照明灯具","疏散指示标志"},
				{"手提式灭火器","推车式灭火器"}
			 };
