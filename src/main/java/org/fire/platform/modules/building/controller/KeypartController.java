...
public class KeypartController extends BaseController{
	...
	private static Logger log = LoggerFactory.getLogger(KeypartController.class);
	...
	public Map<String, Object> queryPage(
	    ...
	    log.info("query,page={},pageSize={},keypartName={}",pageNo,pageSize,keypartName);
	...
	public Keypart get(@RequestParam(value = "id") Long id){
	 ...
	 @ResponseBody
	 public CommonResult create(Keypart bean,HttpSession session,@RequestBody List<Keypart>keyparts){
	 ...
	 @ResponseBody
	 public CommonResult update(Keypart bean,HttpSession session,@RequestBody List<Keypart>keyparts){
