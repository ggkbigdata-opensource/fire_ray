...
public class AppVersionController{
	...
	@Autowired
	private IAppVersionService service;
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<AppVersion> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public AppVersion get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody AppVersion bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody AppVersion bean){
