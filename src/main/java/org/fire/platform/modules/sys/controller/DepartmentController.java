...
public class DepartmentController{
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<Department> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public Department get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody Department bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody Department bean){
