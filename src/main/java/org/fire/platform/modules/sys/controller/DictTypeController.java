...
public class DictTypeController{
	...
	private static Logger log = LoggerFactory.getLogger(DictTypeController.class);
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<DictType> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public DictType get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody DictType bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody DictType bean){
