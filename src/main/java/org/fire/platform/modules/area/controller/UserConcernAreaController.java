...
@Controller
@RequestMapping("/userConcernArea")
public class UserConcernAreaController{

	@Autowired
	private IUserConcernAreaService service;
	private static Logger log = LoggerFactory.getLogger(UserConcernAreaController.class);
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<UserConcernArea> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public UserConcernArea get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody UserConcernArea bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody UserConcernArea bean){
