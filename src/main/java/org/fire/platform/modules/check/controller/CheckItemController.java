...
public class CheckItemController{
	...
	private static Logger log = LoggerFactory.getLogger(CheckItemController.class);
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<CheckItem> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public CheckItem get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody CheckItem bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody CheckItem bean){
