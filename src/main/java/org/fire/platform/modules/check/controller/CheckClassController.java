...
public class CheckClassController{
	...
	@Autowired
	private ICheckClassService service;
	private static Logger log = LoggerFactory.getLogger(CheckClassController.class);
	...
	public Map<String, Object> queryPage(int pageNo,int pageSize,Map<String, Object> params){
	    ...
	    PageInfo<CheckClass> page =  service.queryPageByMap(params, pageNo, pageSize);
	...
	@ResponseBody
	public CheckClass get(@RequestParam(value = "id") Long id){
	    log.info("get,id={}",id);
	 ...
	 @ResponseBody
	 public CommonResult create(@RequestBody CheckClass bean){
	 ...
	 @ResponseBody
	 public CommonResult update(@RequestBody CheckClass bean){
