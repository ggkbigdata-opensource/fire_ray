...
public class FireEventSumController {

    @Autowired
    private IFireEventSumService service;
    private static Logger log = LoggerFactory.getLogger(FireEventSumController.class);
    ...
    public Map<String, Object> queryPage(
        ...
        map.put("extraOrderColumns", " month DESC ");
        PageInfo<FireEventSumBean> page = service.queryPageBeanByMap(map, pageNo, pageSize);
    ...
    @ResponseBody
    public FireEventSum get(@RequestParam(value = "id") Long id) {
        log.info("get,id={}", id);
    ...
    @ResponseBody
    public CommonResult create(@RequestBody FireEventSum bean) {
    ...
    @ResponseBody
    public CommonResult update(@RequestBody FireEventSum bean) {
