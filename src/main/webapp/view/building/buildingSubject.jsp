...
<script type="text/javascript"
    src="<%=request.getContextPath() %>/js/main/fire_system.js"></script>
<link rel="stylesheet" type="text/css"
...
<body>
    <div id="tblQuery" style="padding: 3px">
        <div class="inputDiv">
            <div class="inputDivEg">
                <span class="inputLabel">行政区:</span> <input id="districtId"
                    class="easyui-combobox inputDiv-input" data-options="width:150">
            </div>
            <div class="inputDivEg">
                <span style="font-size: 12px">街道:</span> <input id="streetId"
                    class="easyui-combobox inputDiv-input" data-options="width:150">
            </div>
            <div class="inputDivEg">
                <span class="inputLabel">社区:</span> <input id="blockId"
                    class="easyui-combobox inputDiv-input" data-options="width:150">
            </div>
            <div class="inputDivEg">
                <span class="inputLabel">建筑类别:</span> <input id="baseBuildingClass"
                    class="easyui-combobox inputDiv-input"
                    data-options="editable:false,width:150">
            </div>
            <div class="inputDivEg">
                <span style="font-size: 12px">产权单位名称:</span> <input
                    id="ownerUnitName" class="easyui-textbox inputDiv-input"
                    style="line-height: 20px;" />
            </div>
            <div class="height10"></div>
            <a href="#" class="resetBtn" plain="true" iconCls="icon-search"
                onclick="doSearch()">查询</a> <a href="#" class="queryBtn"
                plain="true" iconCls="icon-undo" onclick="doReset()">重置</a> <a
                href="#" class="queryBtn" plain="true" iconCls="icon-print"
                onclick="doImport()">导入</a>
        </div>
    </div>
    <div class="tableClass">
        <table id="dg_building_subject" title="数据列表" class="easyui-datagrid"
            ...
            striped="true" pageSize="20" collapsible="true" checkOnSelect="true"
            selectOnCheck="true">
            <thead>
                <tr>
    ...
    <div id="dlgBuildingSubject" class="easyui-dialog"
        style="width: 1024px; height: 650px;" closed="true" closable="false"
        maximizable="true" buttons="#dlg-buttons">
        <div id="buildingSubjectTabs" class="easyui-tabs"
            ...
            <div title="建筑物概况表" style="padding: 22px; height: 440px">
                <form id="fm_building" method="post" novalidate>
                    ...
                    <div class="fitem_building">
                        <label>产权单位名称:</label> <input name="ownerUnitName"
                    ...
                    <div class="fitem_building">
                        <label>设计单位:</label> <input name="designUnit"
                            class="easyui-textbox" prompt="设计单位" />
                    </div>

                    <div class="fitem_building">
                        <label>建设单位:</label> <input name="constructUnit"
                            class="easyui-textbox" prompt="建设单位" />
                    </div>

                    <div class="fitem_building">
                        <label>消防安全负责人:</label> <input name="fireManager"
                            class="easyui-textbox">
                    </div>

                    <div class="fitem_building">
                        <label>联系人姓名:</label> <input name="contactName"
                            class="easyui-textbox">
                    </div>

                    <div class="fitem_building">
                        <label>联系人电话:</label> <input name="contactPhone"
                            class="easyui-textbox" data-options="validType:'length[1,11]'"
                            prompt="请输入11位数字">
                    </div>

                    <div class="fitem_building">
                        <label>上级主管单位:</label> <input name="supChargeUnitName"
                            class="easyui-textbox">
                    </div>

                    <div class="fitem_building">
                        <label>所属行业监管部门:</label> <input name="industrySupervisionDepart"
                            class="easyui-textbox">
                    </div>

                    <div class="fitem_building">
                        <label>建筑类别:</label> <input name="baseBuildingClass"
                            class="easyui-textbox">
                        <!-- <input name="baseBuildingCategory" class="easyui-textbox"> -->
                   ...
                   data-options="required:true,editable:false,width:173" /> -->
                    ...
                    <div class="fitem_building">
                        <label>街道和居委会:</label> <input class="easyui-combotree"
                            id="comCcBlock_building" name="blockId"
                            style="width: 173px; height: 26px" required="true">
                    </div>

                    <div class="fitem_building">
                        <label>建筑高度(m):</label> <input name="conBuildHight"
                            class="easyui-numberbox" precision="0" prompt="请输入数字" />
                    </div>

                    <div class="fitem_building">
                        <label>占地面积(m2):</label> <input name="conCoverArea"
                            class="easyui-numberbox" precision="2" prompt="请输入数字" />
                    </div>

                    <div class="fitem_building">
                        <label>总面积(m2):</label> <input name="totalArea"
                            class="easyui-numberbox" precision="2" prompt="请输入数字" />
                    </div>

                    <div class="fitem_building">
                        <label>地上面积(m2):</label> <input name="overgroundArea"
                            class="easyui-numberbox" precision="2" prompt="请输入数字" />
                    </div>

                    <div class="fitem_building">
                        <label>地下面积(m2):</label> <input name="undergroundArea"
                            class="easyui-numberbox" precision="2" prompt="请输入数字" />
                    </div>
                    ...
                    <div class="fitem_building">
                        <label>地上建筑层数(层):</label> <input name="conFloors"
                            class="easyui-numberbox" precision="0" prompt="请输入数字" />
                    </div>

                    <div class="fitem_building">
                        <label>地下建筑层数(层):</label> <input name="conUnderFloors"
                            class="easyui-numberbox" precision="0" prompt="请输入数字" />
                    </div>

                    <div class="fitem_building">
                        <label>土地使用性质:</label> <input name="conClass"
                            class="easyui-textbox" prompt="土地使用性质">
                    </div>

                    <div class="fitem_building">
                        <label>投入使用时间:</label> <input name="useTime"
                            class="easyui-textbox" prompt="投入使用时间：yyyy-yy-dd">
                    </div>

                    <div class="fitem_building">
                        <label class="area">维保单位:</label> <input name="maintenanceUnit"
                            class="easyui-textbox" prompt="建筑物是否有相关维保单位" />
                    </div>

                    <div class="fitem_building">
                        <label class="area">三方消检:</label> <input
                            name="thirdPartyFireDetection" class="easyui-textbox"
                            prompt="建筑物三年内是否有进行第三方消防设施检测" />
                    </div>
                </form>
           </div>
            ...
            <div title="建筑物主要使用功能表" style="padding: 22px; height: 440px">
                <form id="fm_building_function" method="post" novalidate>
                    ...
                    <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                        onclick="appendFunctionText(parseInt(Math.random()*1000))">添加主要使用功能</a>
                    <div class="fitem" id="buildingFunctionDiv">
                        <ul style="list-style-type: none; display: inline-block; padding: 0;" id="buildingFunctionUl"></ul>
                    </div>
                </form>
            </div>
            ...
            <div title="物业管理单位概况表" style="padding: 22px; height: 440px">
                <form id="fm_management" method="post" novalidate>
                    ...
                    <div class="fitem_building">
                        <label>行业监管部门:</label> <input name="industrySupervisionDepart"
                            class="easyui-textbox">
                    </div>
                    <div class="fitem_building">
                        <label>成立时间:</label> <input class="easyui-datetimebox"
                            name="publishTimeString"
            ...
            <div title="消防重点部位概况表">
                <form id="fm_keypart" method="post" novalidate>
                    <table id="tb_keypart_info" class="firecontrol-table"
            ...
            <div title="主要消防系统概况表" style="padding: 22px; height: 440px">
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#hydrant001')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#hydrant001')">重置</a>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#automaticFire002')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#automaticFire002')">重置</a>
                    </div>
                </div>
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#waterSpraySystem003')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#waterSpraySystem003')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#gasFire004')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#gasFire004')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#bubbleFire004')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#bubbleFire004')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#automaticAlarm005')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#automaticAlarm005')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#smokeSystem006')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#smokeSystem006')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#fireproofRolling007')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#fireproofRolling007')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#powerSupply008')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#powerSupply008')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#evacuationIndicating009')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#evacuationIndicating009')">重置</a>
                    </div>
                </div>
                ...
                <div class="windownTab">
                    ...
                    <div class="windownTabBtnDiv">
                        <a href="javascript:void(0);" class="resetBtn" plain="true"
                            onclick="saveChanges('#buildingExtinguisher010')">保存</a> <a
                            href="javascript:void(0);" class="queryBtn" plain="true"
                            onclick="reject('#buildingExtinguisher010')">重置</a>
                    </div>
                </div>
    ...
    <div id="dlg-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton c6"
            ...
            iconCls="icon-cancel" onclick="cancelAction()" style="width: 90px">取消</a>
    </div>


    <div id="import_building_subject" class="easyui-dialog"
        ...
        <form id="fm_file_building" method="post"
            ...
            <div style="margin-top: 10px;">
                <a
                    href="<%=request.getContextPath() %>/template/building_subject_import_template.xls"
...
$(document).ready(function() {
        ...
        onSelect:function(title){
            ...
            if(dialogTitle == "编辑建筑主体"){
                ...
                if(building_subject_id_tab1){
                    ...
                    if(title != "建筑物概况表"){
                        $.messager.alert("操作提示", "请先填写基础信息！！-test1", "error");
                    }
                }
            }
        }
    ...
    var buildingFunctionTemplate = '<li  style="margin-bottom:5px;">' +
            ...
            '<input class="easyui-textbox" id="_id__isSpecificLocation" required="true" name="isSpecificLocation"  prompt="是否特定场所(是：1/否：0)"/>' +
            '<input class="easyui-textbox" id="_id__funBusinessName" name="funBusinessName" prompt="输入商家名称"/>' +
            '<input class="easyui-textbox" id="_id__funBuildArea" name="funBuildArea" prompt="输入建筑面积（m2）"/>' +
...
function saveUser() {
    ...
    if (index == 0) {
        ...
        if (building_subject_id_tab1) {
            ...
            $.messager.alert("操作提示", "请先填写基础信息！！-test3", "error");
        }
    } else if (index == 3) {
        if(dialogTitle == "编辑建筑主体"){
            building_subject_id_tab1 = $("#fm_building").children("input[name='id']").val();
        ...
        if (building_subject_id_tab1) {
            ...
            $.messager.alert("操作提示", "请先填写基础信息！-test4", "error");
        }
    }
}
